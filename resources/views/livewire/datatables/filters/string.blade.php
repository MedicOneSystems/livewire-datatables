<div x-data class="flex flex-col">
    <input x-on:livewire:load.window="window.livewire.hook('afterDomUpdate', () => {
            $refs.input.value=''
        });" x-ref="input" type="text" class="m-1 text-sm leading-4 flex-grow form-input " wire:change="doTextFilter('{{ $index }}', $event.target.value)" />
